...
public class Enquiry {
    ...
    public Enquiry() {
        ...
        this.enquiryState = false; // Default state is false
    }
    ...
    public Enquiry(String enquirerName, String enquirerAddress, Long enquirerMobile,
                   ...
                   String studentName, Integer enquiryCounter, LocalDate followUpDate, Boolean enquiryState) {
        ...
        this.createdDate = LocalDateTime.now();
        this.updatedDate = LocalDateTime.now();
        this.enquiryState = enquiryState != null ? enquiryState : false;
    }
    ...
    public void setEnquiryState(Boolean enquiryState) {
