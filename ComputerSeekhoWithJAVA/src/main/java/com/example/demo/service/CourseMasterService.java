...
public interface CourseMasterService {
    ...
    void removeDuplicateCoursesByName();
    void removeDuplicateCoursesByNameAndDescription();
    void removeDuplicateCoursesByNameDescriptionAndDuration();
    void removeAllDuplicates();
    List<CourseMaster> findAndRemoveDuplicatesByName();
    List<CourseMaster> findAndRemoveDuplicatesByNameAndDescription();
    List<CourseMaster> findAndRemoveDuplicatesByNameDescriptionAndDuration();
    List<CourseMaster> findAndRemoveAllDuplicates();
} 