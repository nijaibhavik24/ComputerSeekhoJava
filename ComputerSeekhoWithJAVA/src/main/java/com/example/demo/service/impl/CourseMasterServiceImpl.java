...
public class CourseMasterServiceImpl implements CourseMasterService {
    ...
    @Override
    public List<CourseMaster> findDuplicateCoursesByName() {
        return courseMasterRepository.findDuplicateCoursesByName();
    }
    
    @Override
    public List<CourseMaster> findDuplicateCoursesByNameAndDescription() {
        return courseMasterRepository.findDuplicateCoursesByNameAndDescription();
    }
    
    @Override
    public List<CourseMaster> findDuplicateCoursesByNameDescriptionAndDuration() {
        return courseMasterRepository.findDuplicateCoursesByNameDescriptionAndDuration();
    }
    
    @Override
    public List<CourseMaster> findExactDuplicateCourses() {
        return courseMasterRepository.findExactDuplicateCourses();
    }
    
    @Override
    public Long countDuplicateCoursesByName() {
        return courseMasterRepository.countDuplicateCoursesByName();
    }
    
    @Override
    public Long countDuplicateCoursesByNameAndDescription() {
        return courseMasterRepository.countDuplicateCoursesByNameAndDescription();
    }
    
    @Override
    public void removeDuplicateCoursesByName() {
        courseMasterRepository.deleteDuplicateCoursesByNameKeepLowestId();
    }
    
    @Override
    public void removeDuplicateCoursesByNameAndDescription() {
        courseMasterRepository.deleteDuplicateCoursesByNameAndDescriptionKeepLowestId();
    }
    
    @Override
    public void removeDuplicateCoursesByNameDescriptionAndDuration() {
        courseMasterRepository.deleteDuplicateCoursesByNameDescriptionAndDurationKeepLowestId();
    }
    
    @Override
    public void removeAllDuplicates() {
        // Remove duplicates in order of strictness (most strict first)
        removeDuplicateCoursesByNameDescriptionAndDuration();
        removeDuplicateCoursesByNameAndDescription();
        removeDuplicateCoursesByName();
    }
    
    @Override
    public List<CourseMaster> findAndRemoveDuplicatesByName() {
        List<CourseMaster> duplicates = findDuplicateCoursesByName();
        removeDuplicateCoursesByName();
        return duplicates;
    }
    
    @Override
    public List<CourseMaster> findAndRemoveDuplicatesByNameAndDescription() {
        List<CourseMaster> duplicates = findDuplicateCoursesByNameAndDescription();
        removeDuplicateCoursesByNameAndDescription();
        return duplicates;
    }
    
    @Override
    public List<CourseMaster> findAndRemoveDuplicatesByNameDescriptionAndDuration() {
        List<CourseMaster> duplicates = findDuplicateCoursesByNameDescriptionAndDuration();
        removeDuplicateCoursesByNameDescriptionAndDuration();
        return duplicates;
    }
    
    @Override
    public List<CourseMaster> findAndRemoveAllDuplicates() {
        List<CourseMaster> allDuplicates = new ArrayList<>();
        allDuplicates.addAll(findDuplicateCoursesByNameDescriptionAndDuration());
        allDuplicates.addAll(findDuplicateCoursesByNameAndDescription());
        allDuplicates.addAll(findDuplicateCoursesByName());
